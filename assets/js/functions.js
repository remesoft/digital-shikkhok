...
function addLecture() {
  ...
  const lectureName = document.getElementById("lectureNameInput").value;
  ...
  lecturesContainer.insertAdjacentHTML(
    ...
    `<div class="accordion-item mb-3">
      ...
      <div class="accordion-body mt-3">
          ...
          <input type="hidden" name="lectures[${lectureId}][name]" value="${lectureName}">
...
function addTopic() {
  ...
  const urlInput = document.getElementById("topicUrlInput");
  ...
  // Insert topic HTML into the container
  topicContainer.insertAdjacentHTML(
    "beforeend",
    `
    <div class="d-flex justify-content-between align-items-center">
      <div class="position-relative">
        <a href="${url}" target="_blank" class="btn btn-danger-soft btn-round btn-sm mb-0 stretched-link position-static"><i class="fas fa-play"></i></a>
        <span class="ms-2 mb-0 h6 fw-light">${name}</span>
      </div>
      <!-- Edit and cancel button -->
      <div>
        <input type="hidden" name="lectures[${currentLectureId}][topics][${topicId}][name]" value="${name}">
        <input type="hidden" name="lectures[${currentLectureId}][topics][${topicId}][url]" value="${url}">
...
function setDescription() {
  // On form submit, set the content of the hidden input
  document
