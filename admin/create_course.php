          ...
          <form onsubmit="return false">
            ...
            <div id="step-3" role="tabpanel" class="content fade" aria-labelledby="steppertrigger3">
              ...
              <div class="row">
                ...
                <!-- Edit lecture START -->
                <div class="accordion accordion-icon accordion-bg-light" id="lecturesContainer">
                  <!-- Item START -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success my-0" id="addLectureButton" onclick="addLectureButton()">Add Lecture</button>
      </div>
    </div>
  </div>
</div>
