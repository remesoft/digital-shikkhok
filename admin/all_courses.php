    ...
    <div class="card-body">
      ...
      <div class="table-responsive border-0 rounded-3">
        ...
        <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
          ...
          <thead>
            <tr>
              <th scope="col" class="border-0 rounded-start" style="width: 30%;">Course Name</th>
              <th scope="col" class="border-0" style="width: 20%;">Instructor</th>
              <th scope="col" class="border-0" style="width: 10%;">Price</th>
              <th scope="col" class="border-0" style="width: 10%;">Enrolled</th>
              <th scope="col" class="border-0 rounded-end" style="width: 20%;">Action</th>
            </tr>
          </thead>
