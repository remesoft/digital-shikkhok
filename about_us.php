...
$page_title = "About Us | Digital Shikkhok";
ob_start();
?>
		...
		<div class="container">
			...
			<div class="row g-4">
				...
				<div class="col-10 text-center mx-auto position-relative">
					...
					<!-- Title -->
					<h1 class="position-relative fs-2">"ডিজিটাল শিক্ষক" এমন একটি প্ল্যাটফর্ম যেখানে শিক্ষার্থীরা ডিপ্লোমা ইন ইঞ্জিনিয়ারিং কোর্স সহজে ও দক্ষতার সাথে শিখতে পারে।।</h1>
				</div>
				<!-- Title and SVG END -->
			</div>
					...
					<div class="row g-4">
						...
						<div class="col-sm-6 col-md-12">
							<div class="bg-grad rounded-4 p-5 text-start">
								<span class="text-white">আমাদের লক্ষ্য:</span>
								<h3 class="text-white">“নতুন ধারণা এবং পন্থাগুলোর প্রতি খোলামেলা মনোভাব রাখা । নতুন সমস্যা সমাধানের দক্ষতা অর্জন করা। ”</h3>
							</div>
						</div>
						<!-- Image -->
